...
function Footer() {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/pulkit-khowal',
      icon: (
    ...
    {
      name: 'Twitter',
      url: 'https://x.com/the_pulkit_2006',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col">
                <h3 className="text-lg sm:text-xl font-bold text-green-400">Pulkit Khowal</h3>
            ...
            <p className="text-sm text-gray-400 text-center md:text-left max-w-xs">
              Passionate about creating modern web applications with React and cutting-edge technologies.
            </p>
          </div>

          {/* CENTER: Social Links */}
          <div className="flex flex-col items-center space-y-4">
            <h3 className="text-lg font-semibold text-green-400">Connect With Me</h3>
            <div className="flex flex-wrap justify-center gap-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex items-center justify-center w-12 h-12 bg-gray-800 hover:bg-green-500 rounded-full transition-all duration-300 transform hover:scale-110 group"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            <p className="text-sm text-gray-400">
              © {currentYear} Pulkit Khowal. All rights reserved.
            </p>
