      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit}  action="https://formsubmit.co/pulkitkhowal2006@gmail.com" method="POST" className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`flex items-center space-x-3 p-4 rounded-lg text-white ${social.color} transition-all duration-200 transform hover:scale-105`}
                  >
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600 text-center">
                  💡 <strong>Tip:</strong> Feel free to reach out on any platform. I typically respond within 24 hours!
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Freelance Projects</h3>
              <p className="text-gray-600 text-sm">
                Looking for interesting web development projects and collaborations.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">
                Excited to learn about new technologies and share knowledge.
              </p>
            </div>
          </div>
        </div>
